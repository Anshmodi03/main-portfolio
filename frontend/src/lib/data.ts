...
export const projects: Project[] = [
  ...
  },
  {
    id: "connectify",
    name: "Connectify",
    description: "Real-time social platform built with the MERN stack — posts, follows, messaging, and live notifications.",
    longDesc: "Connectify is a full-stack social media platform built on the MERN stack. Features include real-time post feeds, user follow/unfollow, likes, comments, bookmarks, direct messaging, profile management, and a clean dark-mode UI optimised for speed.",
    tags: ["MERN", "Full Stack", "Social"],
    tech: ["React", "JavaScript", "Tailwind CSS", "Node.js", "Express.js", "MongoDB", "Socket.IO", "REST API"],
    year: "2024",
    status: "Complete",
    featured: true,
    image: "/project/connectify.png",
    github: "https://github.com/Anshmodi03/Connectify",
    live: "https://connectify-social-azure.vercel.app/",
    stats: [
